...
async def send_email_report(jobs: List[JobListing], recipient_email: str):
    ...
    try:
        ...
        html_content += """
            ...
            <p><strong>Note:</strong> Jobs are filtered for recent postings (last 7 days) and focus on Third Party Risk, Vendor Risk, and Supplier Risk Assessment roles in Bangalore product companies.</p>
